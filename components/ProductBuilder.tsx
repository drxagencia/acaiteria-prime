                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex flex-col">
                                <span className={`text-sm font-medium ${selected ? 'text-theme' : 'text-gray-700'}`}>
                                  {item.nome}
                                </span>
                              </div>
                            </div>
                            ...
                            {item.preco ? (
                                <span className="text-xs font-semibold text-gray-600">+ R$ {item.preco.toFixed(2).replace('.', ',')}</span>
                            ) : null}
                          </div>
                        );
                      })}
